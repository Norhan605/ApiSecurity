...
namespace APISecurity.Services
{
    public class AuthService : IAuthService
    {
        ...
        public AuthService(UserManager<User> user , RoleManager<IdentityRole> roleManager, IOptions<JWT> jwt)
        {
            _user = user;
        ...
        public async Task<AuthModel> ResigterAsync(RegisterModel model)
        {
